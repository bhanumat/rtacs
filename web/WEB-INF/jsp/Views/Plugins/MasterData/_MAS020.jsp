            ...
            <div class="bs-component">
                <form class="form-horizontal" name="frmNew" id="frmNew">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">ชื่อคำนำหน้า</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="lbStatusNew" class="col-lg-3 control-label"></label>
                            <div class="col-lg-5">
                                <label class="inline">
                                    <input type="checkbox" id="chkStatusNew" name="chkStatusNew" value="E" checked class="ace">
            ...
            <div class="bs-component">
                <form class="form-horizontal" name="frmEdit" id="frmEdit">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="lbStatusEdit" class="col-lg-3 control-label"></label>
                            <div class="col-lg-5">
                                <label class="inline">
                                    <input type="checkbox" id="chkStatusEdit" name="chkStatusEdit" value="E" class="ace">
                                    <span class="lbl"> ใช้งาน</span>
                                </label>

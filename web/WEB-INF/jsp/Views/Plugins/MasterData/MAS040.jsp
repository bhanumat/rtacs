...
<script type="text/javascript">
    var urlList = rootPath + '/Plugins/MasterData/getListMAS040.json';
    var urlDelete = rootPath + '/Plugins/MasterData/setDeleteMAS040.json';
    var urlNew = rootPath + '/Plugins/MasterData/setSaveNewMAS040.json';
    var urlEdit = rootPath + '/Plugins/MasterData/setSaveEditMAS040.json';
    var urlLoad = rootPath + '/Plugins/MasterData/getLoadMAS040.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/MasterData/action.MAS040.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/MasterData/jqgrid.MAS040.js"></script>
        ...
        <div id="ListView" class="row">
            <div class="col-lg-12">
                <div class="row">
                    <form id="frmCriterionSearch" class="form-horizontal">                          
                        <div class="form-group">
                            <label for="lbBankName" class="col-lg-4 control-label"> ชื่อธนาคาร : </label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="txtBankName" name="txtBankName" placeholder="Search">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div id="jqGridContainer" class="row">
                    <div>
                        <table id="gridData_BankjqGrid_List"></table>
                        <div id="gridPager_BankjqGrid_List"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bs-component">
                <form class="form-horizontal" name="frmNew" id="frmNew">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="lbBankCodeNew" class="col-lg-3 control-label">รหัสธนาคาร *</label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="txtBankCodeNew" name="txtBankCodeNew">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lbBankNameNew" class="col-lg-3 control-label">ชื่อธนาคาร </label>
                            <div class="col-lg-5">
            ...
            <div class="bs-component">
                <form class="form-horizontal" name="frmEdit" id="frmEdit">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="lbBankCodeEdit" class="col-lg-3 control-label">รหัสธนาคาร *</label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="txtBankCodeEdit" name="txtBankCodeEdit">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lbBankNameEdit" class="col-lg-3 control-label">ชื่อธนาคาร </label>
                            <div class="col-lg-5">

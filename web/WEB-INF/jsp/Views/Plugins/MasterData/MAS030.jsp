                ...
                <form class="form-horizontal" name="frmNew" id="frmNew">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="txtRankNameNew" name="txtRankNameNew">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div></div>
                            <div class="col-lg-5">
                                <input type="text"  class="form-control" id="txtRankFullnameNew" name="txtRankFullnameNew">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div></div>
                            <div class="col-lg-5">
                                <input type="text"  class="form-control" id="txtRankOrderNew" name="txtRankOrderNew">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="txtRankNameEdit" name="txtRankNameEdit">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div></div>
                            <div class="col-lg-5">
                                <input type="text"  class="form-control" id="txtRankFullnameEdit" name="txtRankFullnameEdit">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div></div>
                            <div class="col-lg-5">
                                <input type="text"  class="form-control" id="txtRankOrderEdit" name="txtRankOrderEdit">
                            </div>
                        </div>
                        <div class="form-group">

...
<script type="text/javascript">
    var urlGetLoadQRY010 = rootPath + '/Plugins/QueryData/getLoadQRY010.json';
    var urlListQRY010_Search = rootPath + '/Plugins/QueryData/getListQRY010_Search.json';
    var urlLoadMemberBeneficiary = rootPath + '/Plugins/QueryData/getListMemberBeneficiaryQRY010.json';
    var urlListQRY010PaymentView = rootPath + '/Plugins/QueryData/getListPaymentViewQRY010.json?id=';
    var urlListQRY010MemberStatusView = rootPath + '/Plugins/QueryData/getListMemberStatusViewQRY010.json?id=';
    var urlListQRY010MemberDeptHistoryView = rootPath + '/Plugins/QueryData/getListMemberDeptHistoryViewQRY010.json?id=';
    var urlListQRY010MemberPaymentTypeHistoryView = rootPath + '/Plugins/QueryData/getListMemberPaymentTypeHistoryViewQRY010.json?id=';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/QueryData/action.QRY010.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_Search.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_View.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_Payment_View.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_Member_Status_View.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_Member_Dept_History_View.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/QueryData/jqgrid.QRY010_Member_Payment_Type_History_View.js"></script>
...
<div class="row">
    <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="jqGridContainer1" class="row jqGridContainer">
                                            <div class="col-xs-12">
                                                <table id="gridData_QRY010_View_Grid_List"></table>
                                                <div id="gridPager_QRY010_View_jqGrid_List"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="jqGridContainer2" class="row jqGridContainer">
                                            <div class="col-xs-12">
                                                <table id="gridData_QRY010_Payment_View_Grid_List"></table>
                                                <div id="gridPager_QRY010_Payment_View_jqGrid_List"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="jqGridContainer3" class="row jqGridContainer">
                                            <div class="col-xs-12">
                                                <table id="gridData_QRY010_Member_Status_View_Grid_List"></table>
                                                <div id="gridPager_QRY010_Member_Status_View_jqGrid_List"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="jqGridContainer4" class="row jqGridContainer">
                                            <div class="col-xs-12">
                                                <table id="gridData_QRY010_Member_Dept_History_View_Grid_List"></table>
                                                <div id="gridPager_QRY010_Member_Dept_History_View_jqGrid_List"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="jqGridContainer5" class="row jqGridContainer">
                                            <div class="col-xs-12">
                                                <table id="gridData_QRY010_Member_Payment_Type_History_View_Grid_List"></table>
                                                <div id="gridPager_QRY010_Member_Payment_Type_History_jqGrid_List"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div id="dialogFormSearchQRY010" class="hide">
                ...
                <div class="row" >
                    <form role="form" class="form-horizontal">
                        ...
                        <div class="col-md-offset-3 col-md-9">
                            <button type="button" id="btnActionSearchQRY010" name="btnActionSearchQRY010" class="fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset btn btn-sm btn-purple"><span class="ace-icon fa fa-search"></span>ค้นหา</button>
                            <button type="button" id="btnActionSearchResetQRY010" name="btnActionSearchResetQRY010"  class="fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search btn btn-sm btn-info"><span class="ace-icon fa fa-retweet"></span>ล้าง</button>
                        </div>
                    </form>
                </div>
                <div id="jqGridContainer" class="row">
                    <div>
                        <table id="gridData_QRY010_For_Search_jqGrid_List"></table>
                        <div id="gridPager_QRY010_For_Search_jqGrid_List"></div>
                    </div>
                </div>
            </div>
        </div>

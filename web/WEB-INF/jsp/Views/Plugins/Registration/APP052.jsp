<%-- 
    Document   : APP052
    Created on : Aug 31, 2014, 1:31:08 PM
    Author     : ITOS
--%>
...
<script type="text/javascript">
    var urlList = rootPath + '/Plugins/Registration/getListAPP052.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP052.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP052.js"></script>
<div class="page-header">
    <h1>
        รับสมัคร
        <small>
            <i class="ace-icon fa fa-angle-double-right"></i>
            จัดพิมพ์บัตรคุมการโอนย้ายหน่วย
        </small>
    </h1>
</div><!-- /.page-header -->
    ...
    <div class="col-xs-12">
        ...
        <div id="ListView" class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div>
                        <button id="btnPrint" type="button"  class="btn btn-pink "><i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i> พิมพ์บัตรคุมการโอนย้ายหน่วย </button>
                    </div>
                </div>

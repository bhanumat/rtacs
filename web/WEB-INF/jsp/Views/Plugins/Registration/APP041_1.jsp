...
<script type="text/javascript">
    var urlLoad = rootPath + '/Plugins/Registration/getLoadAPP041.json';
    var urlList = rootPath + '/Plugins/Registration/getListAPP041_1.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP041_1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP041_1.js"></script>
        ...
        <div id="ListView" class="row">
            <div class="col-xs-12">
                ...
                <div id="jqGridContainer" class="row">
                    <div>
                        <table id="gridData_APP041_1_jqGrid_List"></table>
                        <div id="gridPager_APP041_1_jqGrid_List"></div>
                    </div>
                </div>  
                &nbsp;

...
<script type="text/javascript">
    var urlList = rootPath + '/Plugins/Registration/getListAPP010_FOR_APP040_3.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP040_3.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP040_3.js"></script>
<div class="page-header">
    <h1>
        กำหนดเลขทะเบียนสมาชิก  
        <small>
            <i class="ace-icon fa fa-angle-double-right"></i>
            หน้าแสดงกำหนดเลขทะเบียนสมาชิก
        </small>
    </h1>
</div><!-- /.page-header -->
...
<div class="row">
    <input type="hidden" id="hidOperationId" name="hidOperationId" value="${operationId}">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        ...
        <div id="ListView" class="row">
            <div class="col-lg-12">
                ...
                <br/>
                <div class="row">
                    <button type="button" id="btnBack" name="btnBack" class="btn btn-sm"><i class="ace-icon fa fa-retweet"></i>กลับไปหน้าหลัก</button>
                </div>
                <div id="jqGridContainer" class="row">
                    <div>
                        <table id="gridData_APP040_3_Grid_List"></table>
                        <div id="gridPager_APP040_3_Grid_List"></div>
                    </div>
                </div>
            </div>
        </div>

...
<script type="text/javascript">
    var urlList = rootPath + '/Plugins/Registration/getListAPP045.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP045.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP045.js"></script>
    ...
    <div class="col-xs-12">
        ...
        <div id="ListView" class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div>
                        <button id="btnPrint" type="button"  class="btn btn-pink "><i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i> พิมพ์ใบตอบรับ </button>
                    </div>
                </div>

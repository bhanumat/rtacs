...
<script type="text/javascript">
    var urlList = rootPath + '/Plugins/Registration/getListAPP051.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP051.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP051.js"></script>
<div class="page-header">
    <h1>
        รับสมัคร
        <small>
            <i class="ace-icon fa fa-angle-double-right"></i>
            จัดพิมพ์บัตรคุมเงินสงเคราะห์
        </small>
    </h1>
</div><!-- /.page-header -->
    ...
    <div class="col-xs-12">
        ...
        <div id="ListView" class="row">
            <div class="col-lg-12">
                <div class="row">
                    <form id="frmCriterionSearch" class="form-horizontal">                          
                        <div class="form-group">
                            ...
                            <!--div class="col-md-2"-->
                            <label for="lbDocStartDate" class="col-md-2 control-label no-padding-right">วันที่ขึ้นทะเบียน ตั้งแต่</label>
                            <!--/div-->  
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <label for="lbTypeApplySearch" class="col-md-2 control-label no-padding-right">ประเภทการชำระเงิน</label>
                            <div class="col-md-3">
                                <select id="slTypeApplySearch" name="slTypeApplySearch" class="form-control select2">
                                    <option value="%">ทั้งหมด</option>
                                    <option value="10">ชำระผ่านหน่วย</option>
                                    <option value="11">ผู้ชำระแทน</option>
                                    <option value="20">ชำระด้วยตนเอง (เงินสด)</option>
                                    <option value="21">ชำระผ่านธนาณัติ</option>
                                    <option value="22">ชำระผ่านธนาคาร</option>
                                </select>
                            </div>     
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div>
                        <button id="btnPrint" type="button"  class="btn btn-pink "><i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i> พิมพ์บัตรคุมเงินสงเคราะห์  </button>
                    </div>
                </div>

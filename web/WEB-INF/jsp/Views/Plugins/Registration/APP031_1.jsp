...
<script type="text/javascript">
    var urlLoad = rootPath + '/Plugins/Registration/getLoadAPP031.json';
    var urlList = rootPath + '/Plugins/Registration/getListAPP031_1.json';
...
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/action/Registration/action.APP031_1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/Scripts/plugins/jqgrid/Registration/jqgrid.APP031_1.js"></script>
        ...
        <div id="ListView" class="row">
            <div class="col-xs-12">
                ...
                <div id="jqGridContainer" class="row">
                    <div>
                        <table id="gridData_APP031_1_jqGrid_List"></table>
                        <div id="gridPager_APP031_1_jqGrid_List"></div>
                    </div>
                </div>  
                &nbsp;

...
//================================== Parameter jqGrid ========================================
var gridUrl = urlList;
var gridName = '#gridData_MilitaryDepartmentGrid_List';
var gridPager = '#gridPager_MilitaryDepartmentGrid_List';
var gridSortName = 'name';
var gridSortOrder = 'asc';
var gridCaption = 'ข้อมูลหน่วยต้นสังกัด';
var gridColNames = ['ลำดับ', 'รหัสหน่วย', 'หน่วยต้นสังกัด', 'ชื่อเต็มหน่วยต้นสังกัด','สถานะ', ''];
var gridColModel = [
    {name: 'militaryId', index: 'militaryId', hidden: true, align: 'left'},
    {name: 'mildeptId', index: 'mildeptId', align: 'left', sortable: true, width: 75},
    {name: 'name', index: 'name', align: 'left', sortable: true, width: 150},
    {name: 'fullname', index: 'fullname', align: 'left', sortable: true, width: 150},
    {name: 'status', index: 'status', align: 'center', sortable: false, width: 100},

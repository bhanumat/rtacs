...
//================================== Parameter jqGrid ========================================
var gridUrl = urlList;
var gridName = '#gridData_BankjqGrid_List';
var gridPager = '#gridPager_BankjqGrid_List';
var gridSortName = 'bankName';
var gridSortOrder = 'asc';
var gridCaption = 'ข้อมูลธนาคาร';
var gridColNames = ['ลำดับ', 'รหัสธนาคาร', 'ชื่อธนาคาร', 'สถานะใช้งาน', ''];
var gridColModel = [
    {name: 'bankCode', index: 'bankCode', hidden: true, align: 'left'},
    {name: 'bankCode', index: 'bankCode', align: 'left', sortable: true, width: 150},
    {name: 'bankName', index: 'bankName', align: 'left', sortable: true, width: 400},
...
var gridJsonReader = {
    ...
    repeatitems: false,
    id: "bankCode"           //the unique id of the row
};

...
//================================== Parameter jqGrid ========================================
var gridUrl = urlList;
var gridName = '#gridData_BankBranchGrid_List';
var gridPager = '#gridPager_BankBranchGrid_List';
var gridSortName = 'branchCode';
var gridSortOrder = 'asc';
var gridCaption = 'ข้อมูลสาขาธนาคาร';
var gridColNames = ['ลำดับ', 'ชื่อธนาคาร', 'รหัสสาขา', 'ชื่อสาขา', 'สถานะ', ''];
var gridColModel = [
    {name: 'branchId', index: 'branchId', hidden: true, align: 'left'},
    {name: 'bankName', index: 'bankCode', align: 'left', sortable: true, width: 400},
    {name: 'branchCode', index: 'branchCode', align: 'left', sortable: true, width: 200},
    {name: 'branchName', index: 'branchName', align: 'left', sortable: true, width: 300},
...
var gridJsonReader = {
    ...
    repeatitems: false,
    id: "branchId"           //the unique id of the row
};

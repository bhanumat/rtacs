...
var gridSortName = 'provinceName';
var gridSortOrder = 'asc';
var gridCaption = 'ข้อมูลจังหวัด';
var gridColNames = ['ลำดับ', 'รหัสจังหวัด', 'ชื่อจังหวัด', 'สถานะใช้งาน', ''];
var gridColModel = [
    {name: 'provinceCode', index: 'provinceCode', hidden: true, align: 'left'},
    {name: 'provinceCode', index: 'provinceCode', align: 'left', sortable: true, width: 150},
    {name: 'provinceName', index: 'provinceName', align: 'left', sortable: true, width: 400},
...
var gridJsonReader = {
    ...
    repeatitems: false,
    id: "provinceCode"           //the unique id of the row
};

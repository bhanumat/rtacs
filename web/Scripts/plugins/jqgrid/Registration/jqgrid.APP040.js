...
//================================== Parameter jqGrid ========================================
var gridUrl = urlListJsonOperation;
var gridName = '#gridData_OperationGrid_List';
var gridPager = '#gridPager_OperationGrid_List';
var gridSortName = 'operationId';
var gridSortOrder = 'asc';
var gridCaption = 'ข้อมูลหน่วยต้นสังกัด';
var gridColNames = ['ลำดับ', 'กำหนดเลขทะเบียน', 'จำนวนสมาชิก', 'วันที่บันทึก', 'ผู้บันทึก', ''];
var gridColModel = [
    {name: 'operationId', index: 'operationId', hidden: true, align: 'left'},
    {name: 'operationId', index: 'operationId', align: 'left', sortable: true, width: 150},
    {name: 'memberNo', index: 'memberNo', align: 'center', sortable: true, width: 150},
    {name: 'docDate', index: 'docDate', align: 'center', sortable: false, width: 100, formatoptions: {newformat: 'd/m/Y'},

...
//================================== Parameter jqGrid ========================================
var gridName = '#gridData_APP010_2_Edit_Grid_List';
var gridPager = '#gridPager_APP010_2_Edit_jqGrid_List';
    ...
    $(gridName).jqGrid({
        ...
        loadComplete: function() {
            ...
            for (var i = 0; i < ids.length; i++) {
                var id = ids[i];
                var buttonEdit = '<button type="button" type="button" class="btn btn-xs btn-info" alt="Edit" onclick="onDialogEditMemberBeneficiaryEditForEdit(\'' + id + '\');"><i class="ace-icon fa fa-pencil bigger-120"></i> </button>';
                var buttonDelete = '<button type="button" type="button" class="btn btn-xs btn-danger" alt="Delete" onclick="onDialogDeleteMemberBeneficiaryEdit(\'' + id + '\');"><i class="ace-icon fa fa-trash-o bigger-120"></i> </button>';

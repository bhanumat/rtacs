...
var gridCaption = 'รายการพิมพ์ทะเบียนสมาชิก ก.ฌ.๔';
var gridColNames = ['', 'เลขทะเบียนสมาชิก', 'เลขประจำตัวประชาชน', 'ยส - คำนำหน้า', 'ชื่อ', 'สกุล', 'หน่วยต้นสังกัด', 'ประเภทการสมัคร', 'เริ่มชำระศพที่', ''];
var gridColModel = [
    ...
    $(gridName).jqGrid({
        ...
        loadComplete: function() {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                $(gridName).setRowData(ids[i], {action: buttonView, memberTypeCode: memberTypeCode});
            }
            enableTooltips(this);
            //styleCheckbox(this);

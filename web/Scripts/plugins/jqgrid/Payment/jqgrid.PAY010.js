...
var gridColModel = [
    ...
    {name: 'title', index: 'title', align: 'right', sortable: true, width: 90},
    {name: 'name', index: 'name', align: 'left', sortable: true, width: 120},
    {name: 'surname', index: 'surname', align: 'left', sortable: true, width: 120},
    {name: 'amount', index: 'amount', align: 'right', sortable: true, width: 90,
        formatter: 'currency',

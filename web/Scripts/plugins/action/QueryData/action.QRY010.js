$(function () {
    ...
    onRefreshGridMemberBeneficiary = function () {
        ...
        $('#gridData_QRY010_View_Grid_List').setGridParam({
            datatype: 'jsonstring',
    ...
    onPaymentView = function (id) {
        $('#gridData_QRY010_Payment_View_Grid_List').jqGrid('setGridParam', {
            search: false,
            url: urlListQRY010PaymentView + id
        });
        $('#gridData_QRY010_Payment_View_Grid_List').trigger("reloadGrid", [{page: 1}]);
    };

    onMemberStatusView = function (id) {
        $('#gridData_QRY010_Member_Status_View_Grid_List').jqGrid('setGridParam', {
            search: false,
            url: urlListQRY010MemberStatusView + id
        });
        $('#gridData_QRY010_Member_Status_View_Grid_List').trigger("reloadGrid", [{page: 1}]);
    };

    onMemberDeptHistoryView = function (id) {
        $('#gridData_QRY010_Member_Dept_History_View_Grid_List').jqGrid('setGridParam', {
            search: false,
            url: urlListQRY010MemberDeptHistoryView + id
        });
        $('#gridData_QRY010_Member_Dept_History_View_Grid_List').trigger("reloadGrid", [{page: 1}]);
    };

    onMemberPaymentTypeHistoryView = function (id) {
        $('#gridData_QRY010_Member_Payment_Type_History_View_Grid_List').jqGrid('setGridParam', {
            search: false,
            url: urlListQRY010MemberPaymentTypeHistoryView + id
        });
        $('#gridData_QRY010_Member_Payment_Type_History_View_Grid_List').trigger("reloadGrid", [{page: 1}]);
    };
...
//dialogFormSearch
    $("#dialogFormSearchQRY010").removeClass('hide').dialog({
        width: '970px',
        resizable: false,
        modal: true,
        ...
        buttons: [
            {
                ...
                click: function () {
                    onActionDialogFormSearchQRY010();
                }
            }
            ,
            {
    ...
    $("#btnSearchSelect").click(function (event) {
        $("#dialogFormSearchQRY010").dialog("open");
    });

    onActionDialogFormSearchQRY010 = function () {
        var dialogForm = '#dialogFormSearchQRY010';
        var myGrid = $('#gridData_QRY010_For_Search_jqGrid_List');
    ...
    onActionFormSearchQRY010 = function () {
        var search = {};
        ...
        $('#gridData_QRY010_For_Search_jqGrid_List').jqGrid('setGridParam', {
            search: statussearch,
            postData: {
                searchCommand: $.toJSON(search)
            }
        });
        $('#gridData_QRY010_For_Search_jqGrid_List').trigger("reloadGrid", [{page: 1}]);

    };


    $("#btnActionSearchQRY010").click(function (e) {
        e.preventDefault();
        onActionFormSearchQRY010();
    });

    $("#btnActionSearchResetQRY010").click(function (e) {
        e.preventDefault();
    ...
    onActionLoadMilitaryDepartmentQRY010 = function() {
        var objData = {};
        $.ajax({
            type: 'POST',
     ...
     onActionLoadSearchMilitaryDepartmentQRY010 = function() {
        onActionClearSearchMilitaryDepartmentQRY010();
    ...
    onActionClearSearchMilitaryDepartmentQRY010 = function() {
        $('#militaryIdForSearch').empty();
    };
    
    onInit = function() {
        onActionLoadMilitaryDepartmentQRY010();
        onActionLoadSearchMilitaryDepartmentQRY010();
    };

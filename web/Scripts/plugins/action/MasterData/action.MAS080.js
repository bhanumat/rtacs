$(function() {
    ...
    onActionSearch = function() {
        ...
        var search1 = {'groupOp': '', 'field': 'provinceName', 'op': 'cn', 'data': $('#txtProvinceName').val(), 'dataType': 'varchar'};
        requestSearch.push(search1);
        var search2 = {'groupOp': 'and', 'field': 'status', 'op': 'cn', 'data': $('#slStatus').val(), 'dataType': 'char'};
        ...
        $(gridName).jqGrid('setGridParam', {
            ...
            postData: {
                /*searchField: "provinceName",
                 searchOper: "cn",
                 searchString: $('#txtProvinceName').val(),*/
